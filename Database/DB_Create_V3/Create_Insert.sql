 ...
 Tue Nov  4 23:14:44 2025 and edited up to 11/24/2025 7:33PM
 Large edit was in NetProfit as I wanted it to be Revenue - Budget compared to mwb file
 Model: Campaign_Channel    Version: 3.0
...
SET @OLD_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
 ...
 /* *********************************************
Create the Campaign_Channel database.
Drop the database if it already exists.
********************************************** */
DROP DATABASE IF EXISTS `Campaign_Channel`;
